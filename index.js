...
function showDetails(data, connected) {
    ...
    if (data === null) {
        ...
        details_top.innerHTML += `<p>Contributions are welcome! If you have anything to add or correct in the data,
                              ...
                              You can also view the <a href='${REPO_URL}' target='_blank'>sources</a> or open an <a href='${REPO_URL}/issues' target='_blank'>issue on the GitHub repository</a>.</p>`;
        details_top.innerHTML += "<p>&copy; 2024 Simselect contributors. Built with <a href='https://js.cytoscape.org' target='_blank'>cytoscape</a>.</p>"
